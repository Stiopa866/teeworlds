...
image_harpoon = Image("harpoon", "harpoon.png")
...
container.images.Add(image_harpoon)
...
set_harpoon = SpriteSet("harpoon", image_harpoon, 32, 16)
...
set_tee_diving_gear = SpriteSet("tee_diving_gear", image_null, 8, 8)
...
container.spritesets.Add(set_harpoon)
...
container.sprites.Add(Sprite("weapon_harpoon_body", set_harpoon, 20,12,8,3))
container.sprites.Add(Sprite("weapon_harpoon_proj", set_harpoon, 28,12,4,3))
container.sprites.Add(Sprite("weapon_harpoon_cursor", set_harpoon, 0,14,2,2))
...
container.sprites.Add(Sprite("pickup_harpoon", set_harpoon, 2,12,6,2))
...
container.sprites.Add(Sprite("weapon_harpoon_body", set_harpoon, 2,12,6,2))
container.sprites.Add(Sprite("weapon_harpoon_cursor", set_harpoon, 0,12,2,2))
...
container.sprites.Add(Sprite("tee_diving_gear", set_tee_diving_gear, 1,1,6,6))
...
anim = Animation("swim")
#anim.back_foot.frames.Add(AnimKeyframe(0.0, 0-7, 0, -0.1))
#anim.back_foot.frames.Add(AnimKeyframe(0.2, -5-7, 0, -0.1))
#anim.back_foot.frames.Add(AnimKeyframe(0.4,-10-7,0, -0.1))
#anim.back_foot.frames.Add(AnimKeyframe(0.6, -5-7,0, -0.1))
#anim.back_foot.frames.Add(AnimKeyframe(0.8, 5-7,0, -0.1))
#anim.back_foot.frames.Add(AnimKeyframe(1.0, 10-7, 0, -0.1))
...
#anim.front_foot.frames.Add(AnimKeyframe(0.0, 5+7,0, -0.1))
#anim.front_foot.frames.Add(AnimKeyframe(0.2, -5+7,0, -0.1))
#anim.front_foot.frames.Add(AnimKeyframe(0.4, -10+7,0,-0.1))
#anim.front_foot.frames.Add(AnimKeyframe(0.6, -5+7, 0, -0.1))
#anim.front_foot.frames.Add(AnimKeyframe(0.8, 5+7, 0, -0.1))
#anim.front_foot.frames.Add(AnimKeyframe(1.0,10+7,0, -0.1))
