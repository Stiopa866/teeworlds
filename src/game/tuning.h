...
MACRO_TUNING_PARAM(LiquidPressure, liq_pressure, 0)
...
MACRO_TUNING_PARAM(LiquidWeaponInvalidation, liq_inval_weapon, 0)
...
MACRO_TUNING_PARAM(LiquidProjectileResistance, liq_proj_resistance, 0.33f)
...
// weapon tuning
MACRO_TUNING_PARAM(WaterHammerTest, liq_water_hammer_speed, 1.0f)
...
MACRO_TUNING_PARAM(ShotgunWaterResistance, shotgun_liq_resistance, 0.5f)
...
//MACRO_TUNING_PARAM(HarpoonCurvature, grenade_curvature, 1.1)
//MACRO_TUNING_PARAM(HarpoonSpeed, grenade_speed, 1500.0f)
...
MACRO_TUNING_PARAM(HarpoonClampPull, harpoon_clamp_pull, 0.0f)
MACRO_TUNING_PARAM(HarpoonInitialSpeed, harpoon_initial_speed_multiplier, 35.0f)
MACRO_TUNING_PARAM(HarpoonReturnSpeed, harpoon_return_speed_multiplier, 20.0f)
MACRO_TUNING_PARAM(HarpoonElasticity, harpoon_elasticity, 0.5f)
