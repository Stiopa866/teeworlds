...
MACRO_CONFIG_INT(GfxWaterYmultiplier, gfx_waterYmultiplier, 100, 0, 1000000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Debug")
MACRO_CONFIG_INT(GfxWaterXmultiplier, gfx_waterXmultiplier, 100, 0, 1000000, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Debug")
